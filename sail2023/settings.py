"""
Django settings for sail2023 project.
...
load_dotenv(override=True) #necessary to access .env variables after changes made to file
...
WSGI_APPLICATION = 'sail2023.wsgi.application'
