        ...
        <div className="aboutuspage">
            <Container maxWidth="lg">
                ...
                <div className="aboutusdivider">
                    ...
                    <Typography paragraph className="aboutus_text">SAIL is organized by a dedicated team of university students and the School of Computer Science</Typography>
